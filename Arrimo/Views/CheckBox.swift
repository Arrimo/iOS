...
//  Arrimo
//
//  Created by JJ Zapata on 5/7/21.
//
...
open class CheckBox: UIControl {
    ...
    @IBInspectable
    var checkedBorderColor: UIColor = UIColor(red: 0/255, green: 208/255, blue: 102/255, alpha: 1)
    
    @IBInspectable
    var checkmarkColor: UIColor = UIColor(red: 0/255, green: 208/255, blue: 102/255, alpha: 1)
    
    @IBInspectable
    var checkboxBackgroundColor: UIColor! = UIColor(red: 0/255, green: 208/255, blue: 102/255, alpha: 1)
    ...
    open override func draw(_ rect: CGRect) {
        ...
        context.setStrokeColor(self.isChecked ? checkedBorderColor.cgColor : UIColor(red: 171/255, green: 169/255, blue: 169/255, alpha: 1).cgColor)
        context.setFillColor(self.isChecked ? checkedBorderColor.cgColor : UIColor.white.cgColor)
